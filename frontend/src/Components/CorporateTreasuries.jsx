...
function CorporateTreasuries() {
  ...
  const barChartData = {
    ...
    datasets: [{
      ...
      backgroundColor: [
        'rgba(0,179,255,0.8)', 'rgba(74,222,128,0.8)', 'rgba(251,191,36,0.8)',
        'rgba(239,68,68,0.8)', 'rgba(168,85,247,0.8)', 'rgba(236,72,153,0.8)',
        'rgba(14,165,233,0.8)', 'rgba(34,197,94,0.8)', 'rgba(249,115,22,0.8)', 'rgba(139,92,246,0.8)'
      ],
      borderRadius: 6,
      borderWidth: 0,
    }]
  ...
  const doughnutData = {
    ...
    datasets: [{
      ...
      backgroundColor: [
        'rgba(0,179,255,0.8)', 'rgba(74,222,128,0.8)', 'rgba(251,191,36,0.8)',
        'rgba(239,68,68,0.8)', 'rgba(168,85,247,0.8)',
      ],
      borderColor: '#1a1a1a',
      borderWidth: 3,
    }]
  ...
  const barChartOptions = {
    ...
    scales: {
      x: { ticks: { color: '#888', callback: (v) => formatNumber(v) }, grid: { color: '#333' } },
  ...
  const doughnutOptions = {
    ...
    maintainAspectRatio: false,
    plugins: {
      legend: { position: 'right', labels: { color: '#ccc', padding: 15, font: { size: 11 } } },
      tooltip: {
        callbacks: {
